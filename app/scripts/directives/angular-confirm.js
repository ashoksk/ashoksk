    ...
    return {
        ...
        link: function (scope, element, attrs) {
            ...
            var html = "<div id=\"button-" + buttonId + "\" class=\"" + classes + "\">" +
                            "<p class=\"confirmbutton-msg\" style='font-size:12px;'>" + message + "</p>" +
                            "<button class=\"confirmbutton-yes btn btn-success btn-xs\">" + yep + "</button>" + "&nbsp;" +
                            "<button class=\"confirmbutton-no btn btn-danger btn-xs\">" + nope + "</button>" +
                        "</div>";
